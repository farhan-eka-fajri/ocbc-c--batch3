...
VALUES
    ('Farhan','Eka','Fajri','082391906458','jl. jambu no 8','jl. keputih no3','Batam','Kepulauan Riau','29438','Indonesia',1,20000000),
    ('Mukidi','Ihsan','Fadhil','08123456789','jl. paya no 21','-','Semarang','Jawa Tengah','11223','Indonesia',1,15000000),
    ('Dzaky','Rifqi','Dzaky','08080808088','jl. apel no 3','jl. kasuari no 22','Surabaya','Jawa Timur','60111','Indonesia',2,30000000),
    ('Benned','Zakiy','Benned','082659377594','jl. melon no 19','-','Bandung','Jawa Barat','74937','Indonesia',2,40000000),
    ('Faisol','Sebas','Faisol','0834775t2333','jl. anggrek no 1','jl. keputih no 11','Surabaya','Jawa Timur','60111','Indonesia',3,30000000);
...
VALUES 
    ('Mitshubishi',0,5,'Mitshubishi','Car',200,650000,500000),
    ('Toyota',0,7,'Toyota','Car',300,1100000,1000000),
    ('Ford',1,6,'Ford','Car',4000,35000,35000),
    ('Volkswagen',2,5,'Volkswagen','Car',1300,25000,23000),
    ('Tesla',2,10,'Tesla','Electric',500,52000,50000);
...
VALUES
    ('Mobil','mitsubishi.html','mitshubishi.jpg'),
    ('Mobil','toyota.html','toyota.jpg'),
    ('Mobil','ford.html','ford.jpg'),
    ('Mobil','volkswagen.html','volkswagen.jpg'),
    ('Elektrik','tesla.html','tesla.jpg');
...
VALUES
    ('maylani','indah','-','indah@mail.com',0,0,'Head Of engineer'),
    ('angeliana','grace','-','grace@mail.com',1,0,'Head Of Office'),
    ('risa','indira','-','indira@mail.com',1,1,'Office boy'),
    ('fransiska','elisa','-','elisha@mail.com',2,1,'counter'),
    ('siti','nadia','-','nad@mail.com',2,1,'office staff');
